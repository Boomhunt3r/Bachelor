...
The asset is going to be updated frequently. If you have suggestions or monsters you want to see in the future then please contact us on: yazun.shn@gmail.com
...
-------------------------------------------------------------------------------------------------
++//++//++//++++//++//++//++
++//++//++//++ LIMITED TIME: Write a review for this asset and we will give you our next asset (Animated Warrior Playable Characters) for FREE. Ends when this asset gets 5 total reviews.
++//++//++//++ Also, send us an email when you review the asset so we can send you the code when the asset is released.
++//++//++//++++//++//++//++
-------------------------------------------------------------------------------------------------
